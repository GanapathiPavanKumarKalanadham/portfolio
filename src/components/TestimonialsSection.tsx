...
import { Star, Quote, Send, Plus } from 'lucide-react';
  ...
  const [testimonials, setTestimonials] = useState<Testimonial[]>([
    {
      ...
      content: 'Working with Ganapathi was an absolute pleasure. The attention to detail and technical expertise exceeded our expectations. The project was delivered on time and the code quality was exceptional.',
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium transition-all duration-300 hover:shadow-lg"
          >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex space-x-4">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium transition-all duration-300 hover:shadow-lg"
                    >
                      Submit Testimonial
                    </motion.button>
                    <motion.button
          ...
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-6 border transition-all duration-300 ${
                isDark 
                  ? 'bg-gray-800/50 backdrop-blur-md border-gray-700 hover:border-blue-500' 
                  : 'bg-white/50 backdrop-blur-md border-gray-200 hover:border-indigo-500'
              }`}
            >
